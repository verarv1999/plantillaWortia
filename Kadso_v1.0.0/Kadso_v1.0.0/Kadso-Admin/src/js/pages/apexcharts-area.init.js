...
var chart = new ApexCharts(
  document.querySelector("#negative_area_chart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#datetime_Xaxis_area_chart"),
  options
);
chart.render();
