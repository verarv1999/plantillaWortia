...
var options = {
    ...
    colors: ['#4a98f5', '#836ccb', '#fd7e14', '#495057'],
    legend: {
        position: 'right',
        offsetY: 40
    },
...
var options = {
    ...
    colors: ['#4a98f5', '#836ccb', '#f2c94c', '#20c997'],
    yaxis: {
        labels: {
            formatter: (val) => {
                return val / 1000 + 'K'
...
var options = {
    ...
    colors: ['#4a98f5', '#836ccb', '#f2c94c', '#d63384', '#343a40'],
    plotOptions: {
        bar: {
            columnWidth: '45%',
            distributed: true,
