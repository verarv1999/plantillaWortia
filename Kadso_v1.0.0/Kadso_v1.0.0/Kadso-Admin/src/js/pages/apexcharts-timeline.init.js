...
var options = {
    ...
    colors: [
        "#001b2f", "#0ab39c", "#f7b84b", "#4a98f5", "#ced4da",
        "#0ab39c", "#f7b84b", "#4a98f5", "#8D5B4C", "#6610f2",
        "#adb5bd", "#1B998B", "#836ccb", "#F46036", "#0ab39c"
    ],
    fill: {
        type: 'solid'
    },
